...
public class InvestmentPortfolio {
    ...
    public void processBuyTransaction(String fundCode, double amount) {
        ...
        fundCodeValidations(fundCode, amount);
    ...
    // Intento de refactorizacion de la creacion de los tipos de transaccion
    /*public Transaction createTransactions(String transaccion, String fundCode, double amount) {
        if(transaccion == "SELL"){
                String transactionId = UUID.randomUUID().toString();
                Date transactionDate = new Date();
                Transaction sellTransaction = new Transaction(
    ...
    //Validaciones de fundCode y amount
    public void fundCodeValidations(String fundCode, double amount) {
